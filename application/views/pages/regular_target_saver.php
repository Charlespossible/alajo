            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-tabs">
                    ...
                    <h3 class="menu-title">Alajo Sections</h3><!-- /.menu-title -->
                     ...
                     <li>
                        <a href="withdraw.php"   aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Withdraw</a>
                    </li>
                    <li>
        ...
        <div class="content mt-3">
            ...
            <!--<div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                  <span class="badge badge-pill badge-success"><?php //$name = "Charles"; echo $name ?> </span> Good Afternoon, Welcome to your dashboard.
            ...
            <hr>
             ...
             <div class="col-lg-7 box alert alert-dark" role="alert">
                <h3 class="alajo-head text-center">Regular Target Saver</h3>
         
             
<form method ="POST" action ="<?php echo base_url(); ?>dashboard/RegularTargetSaver" id = "formfield">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    Regular Target Savings Confirmation
                </div>
