...
<div class="container" style="margin-top:60px;">
  <h2 class="text-center">Target Saver Data</h2>
...
<script>
    ...
    var plans = "<?php echo $frequency; ?>"; 
    var customerName = "<?php echo $Fullname; ?>";
    var TargetAmount = "<?php echo $amount; ?>";
    var AlajoRefCode = "<?php echo $refcode; ?>";
    var customerEmail = "<?php echo $email; ?>";
    var SavingsDuration = "<?php echo $month; ?>";
