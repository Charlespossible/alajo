           ...
           <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="card-body pb-0">
                        <div class="float-right">
                            <button class="btn bg-transparent  text-light" type="button" id="" >
                                ...
                                <span class="icon">Expected Interest</span>
                            </button>
                    ...
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            <button class="btn bg-transparent  text-light" type="button" id="">
                                ...
                                <span class="icon">Referal Value</span>
                            </button>
                    ...
                    <div class="card-body pb-0">
                        <div class="float-right">
                            <button class="btn bg-transparent text-light" type="button" id="" >
                                ...
                                <span class="icon">Total Savings</span>
                            </button>
            ...
            <hr>
             ...
             <div class="col-lg-7 box alert alert-dark" role="alert">
                <h3 class="alajo-head">Target Saver</h3>
                <p class="my-txt">Allows you to auto save funds from your choosen bank account</p>
                
                <a class="btn btn-lg btn-success my-btn" role ="button" href ="<?php echo base_url(); ?>dashboard/exclusivetargetsaver"> Click To Start</a>

            </div> 
            <hr>
             <div class="col-lg-7 box alert alert-dark">
                <h3 class="alajo-head">Fast Saver</h3>
